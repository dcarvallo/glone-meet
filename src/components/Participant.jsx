...
const Participant = ({ participant, selectParticipant, fullScreenToogle,raiseHand,micsOff ,width}) => {
  ...
  return (
    <div onClick={() => selectParticipant(participant.sid)} style={{cursor: 'pointer', width:'100%'}} className="participant">
      <Box style={{width: fullScreenToogle ? '90%' : '97%', position:'relative', borderRadius: '10px', backgroundColor: "#585858", padding: '4px 4px 0 3px'}} sx={{width: fullScreenToogle ?  '90%' : '250px'}}>
        <video ref={videoRef} style={{ width: width ? width : '100%' , height: fullScreenToogle ? "90%": "150px", objectFit: "cover", position: 'relative',borderRadius:"10px"}} autoPlay={true} />
